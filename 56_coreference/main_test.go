...
func TestUpdateToRepresentiveMention(t *testing.T) {
	for _, testcase := range coreferenceTests {
		t.Log(testcase.name)
		...
		result := root.Document.updateToRepresentiveMention()
