...
var casePatternTests = []struct {
	...
	{
		name: "should return empty string due to containing no case pattern",
...
EOS`,
	...
	{
		name: "should return formatted case pattern",
		text: `EOS
* 0 1D 0/1 1.816431
...
func TestCasePattern(t *testing.T) {
	for _, testcase := range casePatternTests {
		...
		result := newChunkPassage(r).stringifyCasePattern()
