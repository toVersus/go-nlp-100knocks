...
var selectRefTests = []struct {
	...
	{
		name:    "should return fields and values of 3 templates as dictionary object",
		file:    "./test.json",
	...
	{
		name: "should return empty dictonary object",
		file: "./test.json",
...
func TestSelectRef(t *testing.T) {
	for _, testcase := range selectRefTests {
		t.Log(testcase.name)
		...
		result := articles.selectTemplate()
