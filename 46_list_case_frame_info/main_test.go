...
EOS`,
	...
	{
		name: "should return formatted case frame information",
		text: `EOS
* 0 1D 0/1 1.816431
...
func TestCaseFrame(t *testing.T) {
	for _, testcase := range caseFrameTests {
		t.Log(testcase.name)

		r := strings.NewReader(testcase.text)
		result := newChunkPassage(r).stringifyCaseFrame()
